...
/**
 * Skeleton page détail facture — back link + hero montant XL + grille d'infos
 * + placeholder PDF. Evite le flash entre le layout générique et le layout
 * spécifique de /invoices/[id].
 */
